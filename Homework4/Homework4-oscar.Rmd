...
Base on how the sd approximate the 200 reference line, we want to pick the most simple models. Therefore, we will pick k = 17 because it is the most simplist and it's sd is on the basic line.
